...
// import categoriesData from '../budget.json';
...
//     (category) => category.month === monthName && category.year === parseInt(year)
//   );
...
//           <div key={idx} className="budgeted-categories">
//             <h2>Budgeted categories: {category.month}, {category.year}</h2>
...
//                   <div>Remaining: ₹{Math.max(0, item.limit - item.spend).toFixed(2)}</div>
//                 </div>
//                 <div className="progress-bar-container">
//                   <div
//                     className={`progress-bar ${item.spend >= item.limit ? 'progress-bar-red' : 'progress-bar-green'}`}
//                     style={{
//                       width: `${Math.min(100, (item.spend / item.limit) * 100)}%`
//                     }}
//                   ></div>
